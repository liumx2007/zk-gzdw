/*
 ...
 Source Server         : root root MySQL57
 Source Server Type    : MySQL
 Source Server Version : 50724
 Source Host           : localhost:3306
 Source Schema         : uec_gd

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 16/11/2018 16:49:25
*/
...
CREATE TABLE `tb_answer`  (
  ...
  `is_right` int(2) NULL DEFAULT NULL,
  `sort` int(11) NULL DEFAULT NULL,
  `subject_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK406FB6AFC1EA2A1D`(`subject_id`) USING BTREE,
...
CREATE TABLE `tb_arrange_date`  (
  ...
  `arrange_date` date NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_arrange_date` VALUES ('0202540c-d240-42f6-80ae-39bcae1ad07c', '2018-10-29');
INSERT INTO `tb_arrange_date` VALUES ('06169b27-1324-475a-b6b6-d5e1d1e804ba', '2018-10-28');
INSERT INTO `tb_arrange_date` VALUES ('0ef033f1-ec7b-4839-8762-e5d151e2810e', '2018-11-17');
INSERT INTO `tb_arrange_date` VALUES ('13c34107-fc60-4641-aa88-782dbe3a7960', '2018-10-23');
INSERT INTO `tb_arrange_date` VALUES ('20e67b5c-e517-4b48-afdc-ff9351d2a46f', '2018-11-07');
INSERT INTO `tb_arrange_date` VALUES ('24cdbf89-a44d-45a0-9f86-99be1260c83a', '2018-11-16');
INSERT INTO `tb_arrange_date` VALUES ('26a94413-fc66-4ba4-85cf-d61e714f0052', '2018-10-30');
INSERT INTO `tb_arrange_date` VALUES ('2cac13d8-a087-4fcb-acad-047df72a0a54', '2018-11-19');
...
INSERT INTO `tb_arrange_date` VALUES ('3cd0135b-1985-4ef7-9352-b53327a1cd3c', '2018-10-25');
INSERT INTO `tb_arrange_date` VALUES ('43dfd7f3-a5d6-4c75-b25a-432c3be13085', '2018-10-17');
INSERT INTO `tb_arrange_date` VALUES ('44f995c4-744d-4ee4-9593-bb4d616e605c', '2018-11-09');
INSERT INTO `tb_arrange_date` VALUES ('485e2577-5767-4246-997a-2634b0d5e2ef', '2018-10-13');
INSERT INTO `tb_arrange_date` VALUES ('50657bc2-f8f6-4273-a926-e3f943705119', '2018-11-10');
INSERT INTO `tb_arrange_date` VALUES ('5184e46b-0894-4ecf-bf2f-da3fb2d606b8', '2018-10-31');
INSERT INTO `tb_arrange_date` VALUES ('5267e973-ee3f-412e-a57d-ddeae7d6d5dd', '2018-11-03');
INSERT INTO `tb_arrange_date` VALUES ('5c30d15f-993d-4273-bf2a-0684bca337b7', '2018-10-24');
INSERT INTO `tb_arrange_date` VALUES ('5dc882a8-cba7-4792-aa57-3eadf04d290e', '2018-11-21');
INSERT INTO `tb_arrange_date` VALUES ('6ad90cb5-3819-4870-8f74-1aa89bcc7013', '2018-10-15');
INSERT INTO `tb_arrange_date` VALUES ('7218d74e-e6c6-4ede-875d-892728bbd31d', '2018-11-25');
INSERT INTO `tb_arrange_date` VALUES ('73d0423e-f731-4ca8-82a3-33ddf695007c', '2018-10-26');
INSERT INTO `tb_arrange_date` VALUES ('791c940a-f8f7-4459-a5f8-8f6c3af63c82', '2018-11-11');
...
INSERT INTO `tb_arrange_date` VALUES ('8412b013-a430-4fba-9b72-fadc1442ea71', '2018-11-13');
INSERT INTO `tb_arrange_date` VALUES ('86981b68-abc2-43e4-91b2-1ba64418f87f', '2018-10-21');
INSERT INTO `tb_arrange_date` VALUES ('92250b26-ac55-44a3-a867-fa4292e24476', '2018-11-15');
INSERT INTO `tb_arrange_date` VALUES ('96fea65f-8477-42ed-a8cb-61fbaff0639b', '2018-11-02');
INSERT INTO `tb_arrange_date` VALUES ('98b831ea-e759-44e7-9420-2d34e043051d', '2018-10-20');
INSERT INTO `tb_arrange_date` VALUES ('9dcbdc0f-7256-4ee4-8b03-b39460439917', '2018-10-22');
INSERT INTO `tb_arrange_date` VALUES ('9e00d9e6-4354-4ea7-8599-191e1297a945', '2018-10-11');
INSERT INTO `tb_arrange_date` VALUES ('a093df89-305f-4df9-ae34-0c53bbdcacb6', '2018-11-12');
INSERT INTO `tb_arrange_date` VALUES ('a717d55e-1cf9-43d2-ad28-594beb1c1d76', '2018-11-05');
INSERT INTO `tb_arrange_date` VALUES ('abd7ae1e-1efd-4f4c-928d-c806c9fd615a', '2018-11-06');
INSERT INTO `tb_arrange_date` VALUES ('ae70e514-e015-4b89-94a2-e34a8b533e77', '2018-11-24');
INSERT INTO `tb_arrange_date` VALUES ('b1ed7610-2df0-40eb-8293-456a898ae315', '2018-11-18');
INSERT INTO `tb_arrange_date` VALUES ('b628fce4-cd7f-4883-a613-b89af4f1a008', '2018-11-20');
INSERT INTO `tb_arrange_date` VALUES ('b749ea29-055f-4c66-869c-7d5abed06c29', '2018-10-10');
INSERT INTO `tb_arrange_date` VALUES ('b8ae40d2-24a5-4351-b187-117134af3a69', '2018-11-01');
INSERT INTO `tb_arrange_date` VALUES ('cfcd5508-c92a-46db-872b-9eed7ff2336b', '2018-10-27');
INSERT INTO `tb_arrange_date` VALUES ('d8b1459c-91ca-42e2-bba0-63b98ef9d134', '2018-11-14');
INSERT INTO `tb_arrange_date` VALUES ('da001e09-452d-4980-b940-41e070ac68a3', '2018-11-23');
INSERT INTO `tb_arrange_date` VALUES ('dca1968a-6d3b-478b-bab9-08c6619e233d', '2018-11-04');
INSERT INTO `tb_arrange_date` VALUES ('de77a950-d07b-4b46-9e94-fa8db427210f', '2018-10-19');
INSERT INTO `tb_arrange_date` VALUES ('df2bd82c-e003-42ab-b347-4f7ade8ed28b', '2018-11-27');
INSERT INTO `tb_arrange_date` VALUES ('eb3a5469-4554-4f32-9493-61403037f7aa', '2018-11-26');
INSERT INTO `tb_arrange_date` VALUES ('f0c06b32-e88d-4cba-98cf-6c8fad463b0f', '2018-11-08');
INSERT INTO `tb_arrange_date` VALUES ('f24102f5-45c4-406d-a45f-6a91c4e55a65', '2018-11-22');
...
CREATE TABLE `tb_arrange_date_detials`  (
  `tb_arrange_date` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `detials` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`tb_arrange_date`, `detials`) USING BTREE,
  UNIQUE INDEX `detials`(`detials`) USING BTREE,
  INDEX `FK76C81A858116AE6F`(`tb_arrange_date`) USING BTREE,
  INDEX `FK76C81A8524486D02`(`detials`) USING BTREE,
  CONSTRAINT `FK76C81A8524486D02` FOREIGN KEY (`detials`) REFERENCES `tb_arrange_detial` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK76C81A858116AE6F` FOREIGN KEY (`tb_arrange_date`) REFERENCES `tb_arrange_date` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_arrange_detial`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `person_id` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `position` int(8) NULL DEFAULT NULL,
  `arrange_date_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` timestamp(0) NULL DEFAULT NULL,
  `updata_time` timestamp(0) NULL DEFAULT NULL,
  `part` int(11) NULL DEFAULT NULL,
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKCF29CB456B2B9996`(`arrange_date_id`) USING BTREE,
  CONSTRAINT `FKCF29CB456B2B9996` FOREIGN KEY (`arrange_date_id`) REFERENCES `tb_arrange_date` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_content`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `folder_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sort` int(8) NULL DEFAULT NULL COMMENT '排序',
  `serial_number` int(8) NULL DEFAULT NULL COMMENT '编号',
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `file_name` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件名或者路径名',
  `sub_file_name` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附属文件，如果存在的话，缩略图等',
  `mapping_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '可执行文件的映像名称',
  `way` tinyint(4) UNSIGNED NULL DEFAULT NULL COMMENT '文件上传方式',
  `type` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `size` bigint(20) NULL DEFAULT NULL,
  `sub_file_size` bigint(20) NULL DEFAULT NULL,
  `suffix` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `add_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `is_system` tinyint(2) NULL DEFAULT NULL COMMENT '系统文件',
  `check_status` int(11) NOT NULL DEFAULT 0,
  `check_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_FOLDER`(`folder_id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `tb_content` VALUES ('4eae7cbc-bda3-4194-8980-bea12bb65b6a', '223abd1c-42d6-4c71-bf3c-b9c5a297afa2', 4, 4, '1313', '23_1.jpg', '23_1_th.jpg', '', 1, '图片文件', 1108545, 6770, '.jpg', '2018-11-15 15:23:43', '2018-11-15 15:23:43', 0, 0, NULL);
INSERT INTO `tb_content` VALUES ('ddd33cd0-e94f-4189-a4d7-3489afe6f8ba', '223abd1c-42d6-4c71-bf3c-b9c5a297afa2', 3, 3, '1', '23.jpg', '23_th.jpg', '', 1, '图片文件', 1108545, 6770, '.jpg', '2018-11-14 14:45:07', '2018-11-14 14:45:07', 0, 0, NULL);
...
CREATE TABLE `tb_customer`  (
  ...
  `js_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `js_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  ...
  `bank_account` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `cf_phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `bz_phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_dkh`  (
  ...
  `job_num` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `photo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `personnel_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `dkh_photo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_folder`  (
  ...
  `root_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `folder_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `path` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `is_system` tinyint(2) NULL DEFAULT NULL COMMENT '系统目录',
...
CREATE TABLE `tb_group`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备组名称',
  `code_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备组代号',
  `server_node_mac` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备组服务器mac地址',
...
-- ----------------------------
-- Table structure for tb_interaction
-- ----------------------------
DROP TABLE IF EXISTS `tb_interaction`;
CREATE TABLE `tb_interaction`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键id',
  `interact_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交互名称',
  `interact_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交互编号',
  `previous_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属业务',
  `folder_type` tinyint(1) NULL DEFAULT NULL COMMENT '类型（1、展项  2、业务  3、交互触点）',
  `hall_id` int(50) NULL DEFAULT NULL COMMENT '营业厅ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_interaction
-- ----------------------------
INSERT INTO `tb_interaction` VALUES ('1', '新能源', '', '', 1, NULL);
INSERT INTO `tb_interaction` VALUES ('2', '光伏', 'SLT-GF', '1', 2, NULL);
INSERT INTO `tb_interaction` VALUES ('3', '典型案例', 'SLY-GF02', '2', 3, NULL);

-- ----------------------------
-- Table structure for tb_interaction_log
-- ----------------------------
DROP TABLE IF EXISTS `tb_interaction_log`;
CREATE TABLE `tb_interaction_log`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键id',
  `interaction_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交互id',
  `click_time` datetime(0) NULL DEFAULT NULL COMMENT '点击时间',
  `session_business` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '业务会话',
  `session_interact` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '触点会话',
  `folder_type` tinyint(1) NULL DEFAULT NULL COMMENT '类型（1、展项  2、业务  3、交互触点）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_item`  (
  ...
  `value` varchar(3000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_item` VALUES ('5', 'n', '9n4m/ffshHUVNWzJoL159A==');
...
CREATE TABLE `tb_message`  (
  ...
  `statu` int(8) NULL DEFAULT 1,
  `watch_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `edit_time` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `tb_order`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '参观状态',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `telephone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '电话号码',
  `number` int(8) NULL DEFAULT NULL COMMENT '参观人数',
  `date` date NULL DEFAULT NULL COMMENT '预约参观时间',
  `add_time` datetime(0) NULL DEFAULT NULL COMMENT '信息提交时间',
  `apm` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上午/下午',
  `qrcode` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '生成二维码存放路径',
  `operator` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '添加人',
...
CREATE TABLE `tb_personnel`  (
  ...
  `age` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sex` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `watch_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `work_position` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `photo` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `work_status` int(12) NULL DEFAULT NULL,
  `work_time` int(11) NULL DEFAULT NULL,
  `remark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `onduty` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `job_num` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '人员工号',
  `bind_status` int(11) NULL DEFAULT 1 COMMENT '绑定状态（0：已绑定，未绑定）',
  `change_time` datetime(0) NULL DEFAULT NULL,
  `pass_work` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `my_work` int(50) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `tb_personnel` VALUES ('0683efa6-e133-4e86-bd3c-9e7aa6dd6b35', '潘慧珠', NULL, '2', '02:00:00:00:00:00', NULL, 'UploadImages/201712061906491.jpg', 2, 0, NULL, NULL, '15-03114', 0, '2018-11-16 16:14:36', 'E10ADC3949BA59ABBE56E057F20F883E', NULL, NULL, NULL);
...
CREATE TABLE `tb_picture`  (
  ...
  `sub_file_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sub_file_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `add_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `tb_power_failure`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `line` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `start_time` datetime(0) NULL DEFAULT NULL,
  `end_time` datetime(0) NULL DEFAULT NULL,
  `publish_time` datetime(0) NULL DEFAULT NULL,
  `blackout_range` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
...
CREATE TABLE `tb_queue`  (
  ...
  `queue_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cons_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cons_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `busi_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cons_tag` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `tb_rfid`  (
  ...
  `rfid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卡号',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '来访者姓名',
  `company_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公司名称',
  `job` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '职位',
  `phone_number` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号',
...
CREATE TABLE `tb_sales_data`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `sshs` int(8) NULL DEFAULT NULL,
  `ssje` double(16, 2) NULL DEFAULT NULL,
  `dzqdsshs` int(8) NULL DEFAULT NULL,
  `dzqdssje` double(16, 2) NULL DEFAULT NULL,
  `ykbzhs` int(8) NULL DEFAULT NULL,
  `dzqdhs` int(8) NULL DEFAULT NULL,
  `this_date` date NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_stat`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `stat_day` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `update_time` timestamp(0) NULL DEFAULT NULL,
  `create_time` timestamp(0) NULL DEFAULT NULL,
  `busy_time` timestamp(0) NULL DEFAULT NULL,
  `free_time` timestamp(0) NULL DEFAULT NULL,
  `leave_time` timestamp(0) NULL DEFAULT NULL,
  `person_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `statu_busy` int(11) NULL DEFAULT NULL,
  `statu_free` int(11) NULL DEFAULT NULL,
  `statu_leave` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `biz_code`(`update_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_stat` VALUES ('3524a902-cb30-48e6-8761-0080f58b85a7', '2018-11-14', '2018-11-14 17:51:08', '2018-11-14 17:27:37', '2018-11-14 17:51:08', NULL, NULL, '0683efa6-e133-4e86-bd3c-9e7aa6dd6b35', 599, 810, 2);
...
INSERT INTO `tb_stat` VALUES ('84026177-8a00-4a61-ba2c-0e68f94d133d', '2018-11-16', '2018-11-16 16:14:36', '2018-11-16 16:06:08', '2018-11-16 16:14:36', NULL, NULL, '0683efa6-e133-4e86-bd3c-9e7aa6dd6b35', 8, 232, 268);
...
CREATE TABLE `tb_station`  (
  ...
  `station_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `station_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `is_gs` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `isthird` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `point_status` tinyint(2) NULL DEFAULT NULL,
  `longitude` double NULL DEFAULT NULL,
  `latitude` double NULL DEFAULT NULL,
  `cdz_num` int(11) NULL DEFAULT 0,
  `cdz_used_num` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_subject`  (
  ...
  `explain_detail` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
...
CREATE TABLE `tb_subject_wrong`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `subject_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `personnel_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `add_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_terminal`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '运行状态',
  `serial_number` int(8) NULL DEFAULT NULL COMMENT '编号',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '终端名称',
  `code_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '别名',
  `ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT 'ip地址',
  `mac` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '物理地址',
...
-- ----------------------------
INSERT INTO `tb_terminal` VALUES ('8d7b5bcb-ffae-4fae-ab4e-a2f4f4372ea4', 'true', 99, '99', '99', '192.168.43.124', '54-EE-75-84-48-CC', '6daa4c79-c0bf-4e35-9f6d-156665263f38', '99');
INSERT INTO `tb_terminal` VALUES ('9a3ad72c-58a1-42e5-9351-5e18b7d3051c', 'false', 104, '', 'TYT1-240e:ff:b253:2f8a:dde9:b068:f0c4:b29c', '240e:ff:b253:2f8a:dde9:b068:f0c4:b29c', '34-DE-1A-E2-2C-8C', '6daa4c79-c0bf-4e35-9f6d-156665263f38', NULL);
...
CREATE TABLE `tb_terminal_content`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `terminal_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '终端id',
  `content_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容id',
  `model` tinyint(4) NULL DEFAULT NULL COMMENT '播放模式',
  `sort` int(8) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_TERMINAL`(`terminal_id`) USING BTREE,
  INDEX `FK_CONTENT`(`content_id`) USING BTREE,
...
CREATE TABLE `tb_user`  (
  ...
  `role` tinyint(4) NULL DEFAULT NULL COMMENT '用户类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_yj`  (
  ...
  `type` int(2) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `bh` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `content` varchar(3000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `add_time` datetime(0) NULL DEFAULT NULL,
  `flag_time` datetime(0) NULL DEFAULT NULL,
  `is_show` int(2) NULL DEFAULT NULL,
  `flag` int(2) NULL DEFAULT NULL,
  `feedback` varchar(3000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `has_fk` int(2) NULL DEFAULT NULL,
...
CREATE TABLE `tb_ykjd`  (
  ...
  `work_order_num` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `dy_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `elec_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `xzrl` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `zrl` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `part1start_date` date NULL DEFAULT NULL,
  `part1end_date` date NULL DEFAULT NULL,
  `part1remain_day` int(11) NULL DEFAULT NULL,
  `part2start_date` date NULL DEFAULT NULL,
  `part2end_date` date NULL DEFAULT NULL,
  `part2remain_day` int(11) NULL DEFAULT NULL,
  `part3start_date` date NULL DEFAULT NULL,
  `part3end_date` date NULL DEFAULT NULL,
  `part3remain_day` int(11) NULL DEFAULT NULL,
  `part4start_date` date NULL DEFAULT NULL,
  `part4end_date` date NULL DEFAULT NULL,
  `part4remain_day` int(11) NULL DEFAULT NULL,
  `part5start_date` date NULL DEFAULT NULL,
  `part5end_date` date NULL DEFAULT NULL,
  `part5remain_day` int(11) NULL DEFAULT NULL,
  `status` int(2) NULL DEFAULT NULL,
  `process` int(2) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
