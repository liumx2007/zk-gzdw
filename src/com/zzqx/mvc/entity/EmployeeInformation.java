...
public class EmployeeInformation {
    ...
    public String getBusinessToday() {
        return businessToday;
    }

    public void setBusinessToday(String businessToday) {
        this.businessToday = businessToday == null ? null : businessToday.trim();
    }
    ...
    public void setAverageProcessTime(String averageProcessTime) {
        this.averageProcessTime = averageProcessTime == null ? null : averageProcessTime.trim();
    }
    ...
    public void setWatchCode(String watchCode) {
        this.watchCode = watchCode == null ? null : watchCode.trim();
    }
    ...
    public void setOnDuty(String onDuty) {
        this.onDuty = onDuty == null ? null : onDuty.trim();
    }
    ...
    public void setBindState(Short bindState) {
    ...
    public void setMyWork(String myWork) {
        this.myWork = myWork == null ? null : myWork.trim();
    }
